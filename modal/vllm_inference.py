...
try:
    volume = modal.Volume.lookup("hormoz", create_if_missing=False)
...
app = modal.App("hormoz")

N_GPU = 1  # tip: for best results, first upgrade to more powerful GPUs, and only then increase GPU count
TOKEN = "my-secret-key"  # auth token. for production use, replace with a modal.Secret
